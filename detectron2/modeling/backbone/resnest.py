# from https://github.com/zhanghang1989/detectron2-ResNeSt
...
class BottleneckBlock(ResNetBlockBase):
    def __init__(
        ...
        *,
        ...
        if self.radix>1:
            from detectron2.layers.splat import SplAtConv2d
...
class DeformBottleneckBlock(ResNetBlockBase):
    def __init__(
        ...
        *,
        ...
        if self.radix>1:
            from detectron2.layers.splat import SplAtConv2d_dcn
