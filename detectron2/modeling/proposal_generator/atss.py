...
class ATSS(torch.nn.Module):
    ...
    def forward(self, images, features, gt_instances):
        ...
        if self.training:
            return self._forward_train(box_cls, box_regression, centerness, gt_instances, anchors)
        else:
            return self._forward_test(images.image_sizes, box_cls, box_regression, centerness, anchors)

    def _forward_train(self, box_cls, box_regression, centerness, gt_instances, anchors):
        loss_box_cls, loss_box_reg, loss_centerness = self.loss_evaluator(
            box_cls, box_regression, centerness, gt_instances, anchors
        )
        losses = {
    ...
    def _forward_test(self, image_sizes, box_cls, box_regression, centerness, anchors):
        boxes = self.box_selector_test(image_sizes, box_cls, box_regression, centerness, anchors)
        return boxes, {}
